        ...
        <div className=" w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
          ...
          <div className=" w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2">
            <div className=" w-full items-center justify-between">
              ...
              <p className=" text-gray-400 text-lg">5.6</p>
            </div>
            <div className=" w-full items-center justify-between">
            ...
            <div className=" w-full flex items-center justify-between">
              ...
              <p className=" text-gray-200 text-xl font-semibold">&#8377;11.2</p>
                ...
                {user ? (
                  ...
                  whileTap={{ scale: 0.8 }}
                  type="button"
                  className=" w-full p-2 rounded-full bg-gradient-to-br from-orange-400 to-orange-500 text-gray-50 text-lg my-2 hover:shadow-lg"
                >
                  Check Out
                </motion.button>
                ):(
